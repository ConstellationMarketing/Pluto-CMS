...
import type { AboutFirmContent, AwardsContent, TestimonialsContent, PracticeAreasIntroContent } from "./homePageTypes";
export type { AboutFirmContent, AwardsContent, TestimonialsContent, PracticeAreasIntroContent };
